...
class EpisodeRecyclerViewAdapter(private val dataSet: ArrayList<EpisodeModel>) : RecyclerView.Adapter<EpisodeRecyclerViewAdapter.EpisodeViewHolder>() {

    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int) = EpisodeViewHolder(LayoutInflater.from(viewGroup.context).inflate(R.layout.episode_recycler_view_item, viewGroup, false))
